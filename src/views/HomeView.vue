              ...
              <div class="grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2 bg-gradient-to-br from-brand-primary to-brand-dark-primary dark:from-brand-light-primary dark:to-brand-primary rounded-2xl p-6 text-white group hover:shadow-xl transition-all duration-300">
                  ...
                  <h3 class="text-xl font-bold mb-2">
                    {{ t('about.differentiators.family.title') }}
                  </h3>
                  <p class="text-white/80 text-sm leading-relaxed">
                    {{ t('about.differentiators.family.description') }}
                  </p>
                </div>
                ...
                <div class="bg-white/90 dark:bg-[#1e202d]/90 backdrop-blur-sm rounded-2xl p-5 shadow-sm hover:shadow-lg transition-all duration-300 group border border-gray-100 dark:border-brand-medium-dark-primary">
                  ...
                  <h3 class="text-gray-900 dark:text-white font-semibold text-base mb-1">
                    {{ t('about.differentiators.custom.title') }}
                  </h3>
                  <p class="text-gray-500 dark:text-gray-400 text-xs leading-relaxed">
                    {{ t('about.differentiators.custom.description') }}
                  </p>
                </div>
                ...
                <div class="bg-white/90 dark:bg-[#1e202d]/90 backdrop-blur-sm rounded-2xl p-5 shadow-sm hover:shadow-lg transition-all duration-300 group border border-gray-100 dark:border-brand-medium-dark-primary">
                  ...
                  <h3 class="text-gray-900 dark:text-white font-semibold text-base mb-1">
                    {{ t('about.differentiators.partnership.title') }}
                  </h3>
                  <p class="text-gray-500 dark:text-gray-400 text-xs leading-relaxed">
                    {{ t('about.differentiators.partnership.description') }}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="lg:col-span-2 lg:row-span-2 bg-gradient-to-br from-brand-primary to-brand-dark-primary dark:from-brand-light-primary dark:to-brand-primary rounded-3xl p-8 text-white group hover:shadow-2xl hover:shadow-brand-primary/20 transition-all duration-300 relative overflow-hidden min-h-[320px] flex flex-col justify-between">
              ...
              <div>
                ...
                <p class="text-white/80 leading-relaxed">
                  {{ t('services.items.customSoftware.description') }}
                </p>
              </div>
            ...
            <GlassCard padding="md">
              ...
              <h3 class="text-gray-900 dark:text-white font-bold text-lg mb-2">
            ...
            <GlassCard padding="md">
              ...
              <h3 class="text-gray-900 dark:text-white font-bold text-lg mb-2">
                {{ t('services.items.ux.title') }}
              </h3>
              <p class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                {{ t('services.items.ux.description') }}
              </p>
            </GlassCard>
              ...
              <div class="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                    {{ t('services.items.uiux.description') }}
                  </p>
                </div>
              </div>
            </div>
            ...
            <GlassCard padding="md">
              ...
              <h3 class="text-gray-900 dark:text-white font-bold text-lg mb-2">
                {{ t('services.items.qa.title') }}
              </h3>
              <p class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                {{ t('services.items.qa.description') }}
              </p>
            </GlassCard>
            ...
            <GlassCard padding="md">
              ...
              <h3 class="text-gray-900 dark:text-white font-bold text-lg mb-2">
                {{ t('services.items.documentation.title') }}
              </h3>
              <p class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed line-clamp-2">
                {{ t('services.items.documentation.description') }}
              </p>
            </GlassCard>
          </div>
        </div>
            ...
            <div class="lg:col-span-5 bg-gradient-to-br from-brand-primary/5 to-brand-alternative/5 dark:from-brand-primary/10 dark:to-brand-alternative/10 rounded-3xl p-6 md:p-8 border border-brand-primary/10 dark:border-brand-light-primary/20">
              ...
              <div class="grid grid-cols-3 gap-3">
                <TechBadge
                  name="Vue.js"
                  icon="vue"
                  :animation-delay="technologiesSection.isVisible.value ? '100' : '0'"
                />
                <TechBadge
                  name="React"
                  icon="react"
                  :animation-delay="technologiesSection.isVisible.value ? '150' : '0'"
                />
                <TechBadge
                  name="Angular"
                  icon="angular"
                  :animation-delay="technologiesSection.isVisible.value ? '200' : '0'"
                />
              </div>
            </div>
            ...
            <div class="lg:col-span-4 bg-white/90 dark:bg-[#1e202d]/90 backdrop-blur-sm rounded-2xl p-6 border border-gray-100 dark:border-brand-medium-dark-primary">
              ...
              <div class="grid grid-cols-3 gap-3">
                <TechBadge
                  name="Node.js"
                  icon="node"
                  :animation-delay="technologiesSection.isVisible.value ? '250' : '0'"
                />
                <TechBadge
                  name="Python"
                  icon="python"
                  :animation-delay="technologiesSection.isVisible.value ? '300' : '0'"
                />
                <TechBadge
                  name="PHP"
                  icon="php"
                  :animation-delay="technologiesSection.isVisible.value ? '350' : '0'"
                />
              </div>
            </div>
            ...
            <div class="lg:col-span-3 bg-white/90 dark:bg-[#1e202d]/90 backdrop-blur-sm rounded-2xl p-6 border border-gray-100 dark:border-brand-medium-dark-primary">
              ...
              <div class="flex justify-center">
                <TechBadge
                  name="Figma"
                  icon="figma"
                  :animation-delay="technologiesSection.isVisible.value ? '400' : '0'"
                />
              </div>
            </div>
            ...
            <div class="lg:col-span-7 bg-white/90 dark:bg-[#1e202d]/90 backdrop-blur-sm rounded-2xl p-6 border border-gray-100 dark:border-brand-medium-dark-primary">
              ...
              <div class="grid grid-cols-4 gap-3">
                <TechBadge
                  name="PostgreSQL"
                  icon="postgresql"
                  :animation-delay="technologiesSection.isVisible.value ? '450' : '0'"
                />
                <TechBadge
                  name="MySQL"
                  icon="mysql"
                  :animation-delay="technologiesSection.isVisible.value ? '500' : '0'"
                />
                <TechBadge
                  name="MongoDB"
                  icon="mongodb"
                  :animation-delay="technologiesSection.isVisible.value ? '550' : '0'"
                />
                <TechBadge
                  name="SQL Server"
                  icon="microsoftsqlserver"
                  :animation-delay="technologiesSection.isVisible.value ? '600' : '0'"
                />
              </div>
            </div>
            ...
            <div class="lg:col-span-5 bg-gradient-to-br from-brand-alternative/5 to-brand-primary/5 dark:from-brand-alternative/10 dark:to-brand-primary/10 rounded-2xl p-6 border border-brand-alternative/10 dark:border-brand-alternative/20">
              ...
              <div class="grid grid-cols-2 gap-3">
                <TechBadge
                  name="AWS"
                  icon="aws"
                  :animation-delay="technologiesSection.isVisible.value ? '650' : '0'"
                />
                <TechBadge
                  name="Azure"
                  icon="azure"
                  :animation-delay="technologiesSection.isVisible.value ? '700' : '0'"
                />
              </div>
            </div>
          </div>
                    ...
                    <div class="relative">
                      ...
                      <div class="relative">
                        ...
                        >
                          ...
                          <option value="pt">
                            {{ t('contact.form.languages.pt') }}
                          </option>
                          <option value="en">
                            {{ t('contact.form.languages.en') }}
                          </option>
                        </select>
