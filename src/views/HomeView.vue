        ...
        <div class="max-w-7xl mx-auto">
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 md:gap-6">
            ...
            <TechBadge
              name="PHP"
              icon="php"
              :animation-delay="technologiesSection.isVisible.value ? '800' : '0'"
            />
            <TechBadge
              name="Angular"
              icon="angular"
              :animation-delay="technologiesSection.isVisible.value ? '900' : '0'"
            />
            <TechBadge
              name="PostgreSQL"
              icon="postgresql"
              :animation-delay="technologiesSection.isVisible.value ? '1000' : '0'"
            />
            <TechBadge
              name="MySQL"
              icon="mysql"
              :animation-delay="technologiesSection.isVisible.value ? '1100' : '0'"
            />
            <TechBadge
              name="MongoDB"
              icon="mongodb"
              :animation-delay="technologiesSection.isVisible.value ? '1200' : '0'"
            />
            <TechBadge
              name="Figma"
              icon="figma"
              :animation-delay="technologiesSection.isVisible.value ? '1300' : '0'"
            />
            <TechBadge
              name="SQL Server"
              icon="microsoftsqlserver"
              :animation-delay="technologiesSection.isVisible.value ? '1400' : '0'"
            />
            <TechBadge
              name="AWS"
              icon="aws"
              :animation-delay="technologiesSection.isVisible.value ? '1500' : '0'"
            />
            <TechBadge
              name="Azure"
              icon="azure"
              :animation-delay="technologiesSection.isVisible.value ? '1600' : '0'"
            />
          </div>
        </div>
      </section>
      ...
      >
        <div class="max-w-6xl mx-auto">
          ...
          <div class="relative">
            ...
            <div class="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-brand-primary via-brand-medium-primary to-brand-light-primary dark:from-brand-light-primary dark:via-brand-medium-primary dark:to-brand-primary opacity-30 hidden md:block" />
            ...
            <div class="space-y-16 md:space-y-24">
              ...
              >
                <!-- Timeline Node -->
                <div class="hidden md:flex absolute left-1/2 transform -translate-x-1/2 w-6 h-6 bg-brand-primary dark:bg-brand-light-primary rounded-full border-4 border-white dark:border-brand-dark shadow-lg z-10" />
