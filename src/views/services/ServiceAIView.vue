...
const serviceMetrics = [
  { value: '95%+', label: 'Acurácia Média' },
  { value: '100+', label: 'Modelos Treinados' },
  { value: '<50ms', label: 'Inferência' },
  { value: '5M+', label: 'Predições/dia' }
]
  ...
  <div class="flex flex-1 flex-col relative">
    ...
    >
      <ServiceHero
        ...
        cta-text="Explorar Casos de Uso IA"
      ...
      >
        <template #visual>
          <ServiceHeroVisual
            service-type="ai"
            :metrics="['ML Models', '<50ms', '95%+ Accuracy', 'TensorFlow']"
          />
        </template>
      </ServiceHero>
    </section>
      ...
      <div class="max-w-7xl mx-auto">
        <div class="text-center mb-12">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-400">
            Modelos otimizados para produção em larga escala
          </p>
        </div>
    ...
    >
      ...
      <div class="max-w-4xl mx-auto text-center relative z-10">
        ...
        <button
          class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-orange-500 dark:bg-orange-400 text-white dark:text-brand-dark rounded-xl font-bold text-lg hover:bg-red-600 dark:hover:bg-orange-500 hover:scale-105 transition-all shadow-lg"
          @click="handleCTA"
        >
