...
const serviceMetrics = [
  { value: '500+', label: 'APIs Integradas' },
...
const processSteps = computed(() => {
  if (!serviceData) return []
  const stepIds = ['discovery', 'design', 'development', 'testing', 'launch']
  ...
  <div class="flex flex-1 flex-col relative">
    ...
    >
      <ServiceHero
        ...
        cta-text="Agendar Demo da Plataforma"
      ...
      >
        <template #visual>
          <ServiceHeroVisual
            ...
            :metrics="['99.9% Uptime', 'TypeScript', 'CI/CD', 'Cloud Native']"
          />
        </template>
      </ServiceHero>
    </section>
      ...
      <div class="max-w-7xl mx-auto">
        <div class="text-center mb-12">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-400">
            Performance e confiabilidade comprovadas em produção
          </p>
        </div>
    ...
    >
      <div class="absolute inset-0 bg-gradient-to-br from-brand-primary to-brand-dark-primary dark:from-brand-light-primary dark:to-brand-primary opacity-10" />
      <div class="max-w-4xl mx-auto text-center relative z-10">
        ...
        <button
          class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-brand-primary dark:bg-brand-light-primary text-white dark:text-brand-dark rounded-xl font-bold text-lg hover:bg-brand-dark-primary dark:hover:bg-brand-medium-primary hover:scale-105 transition-all shadow-lg"
          @click="handleCTA"
        >
