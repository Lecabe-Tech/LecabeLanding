...
const processSteps = computed(() => {
  if (!serviceData) return []
  const stepIds = ['assessment', 'architecture', 'migration', 'optimization', 'support']
  ...
  <div class="flex flex-1 flex-col relative">
    ...
    >
      ...
      >
        ...
        <template #visual-old>
          <div class="relative bg-gradient-to-br from-brand-alternative to-emerald-600 dark:from-brand-light-alternative dark:to-emerald-500 rounded-3xl p-8 shadow-2xl">
    ...
    >
      <div class="absolute inset-0 bg-gradient-to-br from-brand-alternative to-emerald-600 dark:from-brand-light-alternative dark:to-emerald-500 opacity-10" />
