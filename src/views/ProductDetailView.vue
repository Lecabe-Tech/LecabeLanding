...
<template>
  <div class="min-h-screen bg-brand-light dark:bg-brand-dark transition-colors duration-300">
    <!-- Product not found -->
    <div v-if="!product" class="max-w-7xl mx-auto px-6 md:px-12 py-16">
      <div class="text-center">
        <h2 class="section-title mb-4">{{ t('marketplace.detail.notFound') }}</h2>
        <button
          @click="goBack"
          class="btn-primary"
        >
      ...
      <div class="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div class="flex flex-col">
            ...
            <!-- Description -->
            <div class="mb-8">
              <h2 class="card-title mb-3">{{ t('marketplace.detail.description') }}</h2>
        ...
        <div class="mt-16">
          ...
          <div v-if="reviewsLoading" class="text-center py-12">
            <div class="inline-block animate-spin rounded-full h-10 w-10 border-4 border-brand-primary border-t-transparent"></div>
            <p class="mt-4 text-gray-600 dark:text-gray-400">{{ t('marketplace.reviews.loading') }}</p>
          </div>
